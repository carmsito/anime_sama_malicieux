    ...
    <>
      <nav className={`navbar ${scrolled || searchOpen ? 'scrolled' : ''}`}>
        ...
        <div className="nav-actions">
          ...
          <button className="btn btn-ghost btn-sm" onClick={() => navigate('/settings')}>Réglages</button>
          {user?.role === 'admin' && (
            <button className="btn btn-ghost btn-sm" onClick={() => navigate('/admin/users')}>Admin</button>
          )}
          {user?.role === 'admin' && (
            <button className="btn btn-ghost btn-sm" onClick={() => navigate('/admin/console')}>Console</button>
          )}
      ...
      {burgerOpen && (
        <div className="nav-burger-menu">
          ...
          <button className="nav-burger-item" onClick={() => { navigate('/settings'); setBurgerOpen(false) }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {user?.role === 'admin' && (
            <button className="nav-burger-item" onClick={() => { navigate('/admin/console'); setBurgerOpen(false) }}>
