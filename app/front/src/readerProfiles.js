...
export function makeProfile(id, name, allVisible = true) {
  return {
    ...
    state: { scale: 100, scaleLandscape: 100, scrollnav: false, autoscroll: false, speedMult: 1, pause: 0, sens: 1, filter: 'none', brightness: 100 },
    defaults: {},
  }
}
...
export function ensureState(p) {
  if (!p) return p
  const base = { scale: 100, scaleLandscape: 100, scrollnav: false, autoscroll: false, speedMult: 1, pause: 0, sens: 1, filter: 'none', brightness: 100 }
